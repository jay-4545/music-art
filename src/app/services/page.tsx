...
//         All courses ({courseData.services.length})
//       </h1>
  ...
  return (
    <div className="min-h-screen bg-black py-12 pt-36">
      ...
      <div className="flex flex-wrap justify-center gap-6 px-4">
        {courseData.services.map((service) => (
          <CardContainer key={service.id} className="inter-var m-4">
            <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-full max-w-sm sm:max-w-md min-h-[500px] rounded-xl p-6 border flex flex-col justify-between">
              <div>
                <CardItem
                  translateZ="50"
                  className="text-xl font-bold text-neutral-600 dark:text-white"
